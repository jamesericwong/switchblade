...
{
    public partial class NotepadPlusPlusSettingsWindow : Window
    {
        private readonly IPluginSettingsService _settingsService;
        private readonly ObservableCollection<string> _processes;

        public NotepadPlusPlusSettingsWindow(IPluginSettingsService settingsService, List<string> currentProcesses)
        {
            InitializeComponent();
